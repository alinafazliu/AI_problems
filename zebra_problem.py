...
Smoke = ["Winston", "Kools", "Chesterfield", "Luckystrike", "Parliament"]
Pet = ["Dog", "Snails", "Fox", "Horse", "Zebra"]
Drink = ["Tea", "Coffee", "Milk", "Orangejuice", "Water"]

# add variables: house numbers 1 to 5
problem.addVariables(Nationality, range(1, 5 + 1))
...
problem.addConstraint(lambda a, b: a == b, ["Winston", "Snails"])
...
# print the answers
nation = ["Nationality" if i == 0 else "" for i in range(6)]
